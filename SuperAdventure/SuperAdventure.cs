...
namespace SuperAdventure
{
...

    {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            {
                //See if player has the required item to enter
                ...
                {
                    //We didn't find the required item, so display message and stop trying to move
            ...
            {
                //See if player already has the quest and if they have completed it
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        foreach (QuestCompletionItem qci in newLocation.QuestAvailableHere.QuestCompletionItems)
                        {
                            ...
                            foreach (InventoryItem ii in _player.Inventory)
                            {
                                //The player has this item in his inventory
                            ...
                            //If we didn't find the required item, set our variable to stop looking fo rthe other items
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            foreach (InventoryItem ii in _player.Inventory)
                            {
                                ...
                                {
                                    //They have the item in the inventory so add another one
                                    ii.Quantity++;
                            ...
                            //They didn't have the item in their inventory, so increase the quantity by one
            ...
            {
                //The player doesn't have any healing potions, so hide the healing potion combobox and the "Use" button
                cboPotions.Visible = false;
                btnUsePotion.Visible = false;
            }
            else
